# bluewhale Privacy Policy

*Last updated: January 2025*

## Our Commitment

bluewhale is designed with privacy as its foundation. We believe private communication is a fundamental human right. This policy explains how bluewhale protects your privacy.
...
- **Hybrid Functionality** - bluewhale offers two modes of communication:
...
## What Information bluewhale Stores
...
During each session, bluewhale temporarily maintains:
...
### With Other bluewhale Users

When you use bluewhale, nearby peers can see:
...
To provide the core functionality of bluewhale, we access your device's location data. This access is necessary for the following specific purposes:
...
- **How we use it:** We use this permission strictly to discover other bluewhale peers nearby for the "Bluetooth Mesh Chat" mode.
...
bluewhale does not knowingly collect information from children. The app has no age verification because it collects no personal information from anyone.
...
bluewhale is an open source project. For privacy questions:
- Review our code: https://github.com/offlineapps/bluewhale-android
- Open an issue on GitHub
- Join the discussion in public rooms

## Philosophy

Privacy isn't just a feature—it's the entire point. bluewhale proves that modern communication doesn't require surrendering your privacy. No accounts, no servers, no surveillance. Just people talking freely.

---

*This policy is released into the public domain under The Unlicense, just like bluewhale itself.*