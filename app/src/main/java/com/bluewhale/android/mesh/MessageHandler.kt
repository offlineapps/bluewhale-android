...
class MessageHandler(private val myPeerID: String, private val appContext: android.content.Context) {
    ...
    suspend fun handleNoiseEncrypted(routed: RoutedPacket) {
        ...
        try {
            ...
            val noisePayload = com.bluewhale.android.model.NoisePayload.decode(decryptedData)
            ...
            when (noisePayload.type) {
                com.bluewhale.android.model.NoisePayloadType.PRIVATE_MESSAGE -> {
                    ...
                    if (privateMessage != null) {
                        ...
                        // Create BluewhaleMessage - preserve source packet timestamp
                ...
                com.bluewhale.android.model.NoisePayloadType.FILE_TRANSFER -> {
                ...
                com.bluewhale.android.model.NoisePayloadType.DELIVERED -> {
                ...
                com.bluewhale.android.model.NoisePayloadType.READ_RECEIPT -> {
                ...
                com.bluewhale.android.model.NoisePayloadType.VERIFY_RESPONSE -> {
    ...
    private suspend fun sendDeliveryAck(messageID: String, senderPeerID: String) {
        try {
            ...
            val ackPayload = com.bluewhale.android.model.NoisePayload(
                type = com.bluewhale.android.model.NoisePayloadType.DELIVERED,
    ...
    suspend fun handleAnnounce(routed: RoutedPacket): Boolean {
        ...
        if (age > com.bluewhale.android.util.AppConstants.Mesh.STALE_PEER_TIMEOUT_MS) {
            Log.w(TAG, "Ignoring stale ANNOUNCE from ${peerID.take(8)} (age=${age}ms > ${com.bluewhale.android.util.AppConstants.Mesh.STALE_PEER_TIMEOUT_MS}ms)")
            return false
        }
        ...
        try {
            val neighborsOrNull = com.bluewhale.android.services.meshgraph.GossipTLV.decodeNeighborsFromAnnouncementPayload(packet.payload)
        ...
        try {
            ...
            if (response != null) {
                ...
                val responsePacket = BluewhalePacket(
                    ...
                    payload = response,
                    signature = null,
                    ttl = com.bluewhale.android.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS
                )
    ...
    private suspend fun handleBroadcastMessage(routed: RoutedPacket) {
        ...
        try {
            ...
            val isFileTransfer = com.bluewhale.android.protocol.MessageType.fromValue(packet.type) == com.bluewhale.android.protocol.MessageType.FILE_TRANSFER
            val file = com.bluewhale.android.model.BluewhaleFilePacket.decode(packet.payload)
            if (file != null) {
                if (isFileTransfer) {
     ...
     */
    private suspend fun handlePrivateMessage(packet: BluewhalePacket, peerID: String) {
        try {
    ...
    private fun handleFavoriteNotificationFromMesh(content: String, fromPeerID: String) {
        try {
            ...
            if (noiseKey != null) {
                com.bluewhale.android.favorites.FavoritesPersistenceService.shared.updatePeerFavoritedUs(noiseKey, isFavorite)
                if (npub != null) {
                    // Index by noise key and current mesh peerID for fast Nostr routing
                    com.bluewhale.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKey(noiseKey, npub)
                    com.bluewhale.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKeyForPeerID(fromPeerID, npub)
                }
                ...
                val sys = com.bluewhale.android.model.BluewhaleMessage(
                    sender = "system",
...
interface MessageHandlerDelegate {
    ...
    // Packet operations
    fun sendPacket(packet: BluewhalePacket)
    fun relayPacket(routed: RoutedPacket)
    fun getBroadcastRecipient(): ByteArray
    
    // Cryptographic operations
    fun verifySignature(packet: BluewhalePacket, peerID: String): Boolean
    ...
    // Callbacks
    fun onMessageReceived(message: BluewhaleMessage)
