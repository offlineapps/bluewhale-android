...
class FragmentManager {
    ...
    companion object {
        ...
        private const val FRAGMENT_SIZE_THRESHOLD = com.bluewhale.android.util.AppConstants.Fragmentation.FRAGMENT_SIZE_THRESHOLD // Matches iOS: if data.count > 512
        private const val MAX_FRAGMENT_SIZE = com.bluewhale.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE        // Matches iOS: maxFragmentSize = 469 
        private const val FRAGMENT_TIMEOUT = com.bluewhale.android.util.AppConstants.Fragmentation.FRAGMENT_TIMEOUT_MS     // Matches iOS: 30 seconds cleanup
        private const val CLEANUP_INTERVAL = com.bluewhale.android.util.AppConstants.Fragmentation.CLEANUP_INTERVAL_MS     // 10 seconds cleanup check
    }
    ...
    private fun evictIfNeeded() {
        val maxActive = com.bluewhale.android.util.AppConstants.Fragmentation.MAX_ACTIVE_SETS
        synchronized(globalLock) {
    ...
    private fun evictUntil(required: Long) {
        val maxGlobal = com.bluewhale.android.util.AppConstants.Fragmentation.MAX_GLOBAL_BYTES
        synchronized(globalLock) {
