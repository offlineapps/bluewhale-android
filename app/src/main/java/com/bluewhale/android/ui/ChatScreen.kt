...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    val displayMessages = when {
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.bluewhale.android.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.bluewhale.android.geohash.ChannelID.Location
    }
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.bluewhale.android.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.bluewhale.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
...
private fun ChatFloatingHeader(
    ...
    val locationManager = remember { com.bluewhale.android.geohash.LocationChannelManager.getInstance(context) }
