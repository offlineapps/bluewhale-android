...
import com.bluewhale.android.mesh.BluetoothMeshDelegate
import com.bluewhale.android.mesh.BluetoothMeshService
import com.bluewhale.android.service.MeshServiceHolder
import com.bluewhale.android.model.BluewhaleMessage
import com.bluewhale.android.model.BluewhaleMessageType
import com.bluewhale.android.nostr.NostrIdentityBridge
import com.bluewhale.android.protocol.BluewhalePacket


import kotlinx.coroutines.launch
import com.bluewhale.android.util.NotificationIntervalManager
...
import com.bluewhale.android.nostr.GeohashAliasRegistry
import com.bluewhale.android.util.dataFromHexString
import com.bluewhale.android.util.hexEncodedString
import java.security.MessageDigest

/**
 * Refactored ChatViewModel - Main coordinator for bluewhale functionality
...
class ChatViewModel(
    ...
    var meshService: BluetoothMeshService = initialMeshService
        private set
    private val debugManager by lazy { try { com.bluewhale.android.ui.debug.DebugSettingsManager.getInstance() } catch (e: Exception) { null } }
    ...
    val messages: StateFlow<List<BluewhaleMessage>> = state.messages
    ...
    val privateChats: StateFlow<Map<String, List<BluewhaleMessage>>> = state.privateChats
    ...
    val channelMessages: StateFlow<Map<String, List<BluewhaleMessage>>> = state.channelMessages
    ...
    val selectedLocationChannel: StateFlow<com.bluewhale.android.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    init {
        ...
        viewModelScope.launch {
            try { com.bluewhale.android.services.AppStateStore.publicMessages.collect { msgs ->
                // Source of truth is AppStateStore; replace to avoid duplicate keys in LazyColumn
                state.setMessages(msgs)
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.bluewhale.android.services.AppStateStore.privateMessages.collect { byPeer ->
                ...
                try {
                    val seen = com.bluewhale.android.services.SeenMessageStore.getInstance(getApplication())
        ...
        viewModelScope.launch {
            try { com.bluewhale.android.services.AppStateStore.channelMessages.collect { byChannel ->
                // Replace with store snapshot
        ...
        viewModelScope.launch {
            com.bluewhale.android.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.bluewhale.android.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.bluewhale.android.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.bluewhale.android.geohash.ChannelID.Mesh) {
        ...
        com.bluewhale.android.favorites.FavoritesPersistenceService.initialize(getApplication())
        ...
        try {
            val nostrTransport = com.bluewhale.android.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.bluewhale.android.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.bluewhale.android.nostr.NostrSubscriptionManager
                val identity = com.bluewhale.android.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.bluewhale.android.nostr.NostrDirectMessageHandler
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.bluewhale.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.bluewhale.android.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.bluewhale.android.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, meshService, meshService.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.bluewhale.android.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.bluewhale.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.bluewhale.android.services.MessageRouter.getInstance(getApplication(), meshService)
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.bluewhale.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.bluewhale.android.identity.SecureIdentityStateManager(getApplication())
                ...
                com.bluewhale.android.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    val myNostr = com.bluewhale.android.nostr.NostrIdentityBridge.getCurrentNostrIdentity(getApplication())
    ...
    private fun updateReactiveStates() {
        ...
        sessionStates.forEach { (peerID, newState) ->
            ...
            if (old != "established" && newState == "established") {
                com.bluewhale.android.services.MessageRouter
    ...
    override fun didReceiveMessage(message: BluewhaleMessage) {
    ...
    fun panicClearAllData() {
        ...
        com.bluewhale.android.features.file.FileUtils.clearAllMedia(getApplication())
        ...
        try {
            ...
            try {
                val store = com.bluewhale.android.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }
    ...
    fun selectLocationChannel(channel: com.bluewhale.android.geohash.ChannelID) {
