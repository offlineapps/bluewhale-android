...
import com.bluewhale.android.nostr.GeohashMessageHandler
import com.bluewhale.android.nostr.GeohashRepository
import com.bluewhale.android.nostr.NostrDirectMessageHandler
import com.bluewhale.android.nostr.NostrIdentityBridge
import com.bluewhale.android.nostr.NostrProtocol
import com.bluewhale.android.nostr.NostrRelayManager
import com.bluewhale.android.nostr.NostrSubscriptionManager
import com.bluewhale.android.nostr.PoWPreferenceManager
import com.bluewhale.android.nostr.GeohashAliasRegistry
import com.bluewhale.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.bluewhale.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.bluewhale.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.bluewhale.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.bluewhale.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.bluewhale.android.model.BluewhaleMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.bluewhale.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.bluewhale.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.bluewhale.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.bluewhale.android.model.BluewhaleMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.bluewhale.android.geohash.ChannelID?) {
