...
import com.bluewhale.android.MainActivity
...
class MeshForegroundService : Service() {
    ...
    companion object {
        ...
        const val ACTION_QUIT = "com.bluewhale.android.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.bluewhale.android.service.UPDATE_NOTIFICATION"
        const val ACTION_NOTIFICATION_PERMISSION_GRANTED = "com.bluewhale.android.action.NOTIFICATION_PERMISSION_GRANTED"
    ...
    private fun buildNotification(activePeers: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(
                ...
                getString(R.string.notification_action_quit_bluewhale),
                quitPendingIntent
            )
            .build()
    }
